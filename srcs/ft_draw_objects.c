...
/*   Updated: 2021/09/10 11:15:54 by alellouc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_draw_map(t_player *player)
{
	...
	mlx_string_put(player->screen->mlx, player->screen->win, player->pole_pos->x - player->coef / 2, player->pole_pos->y - 2 * player->coef, 0, "P");
	return (0);
}
